@echo off
REM from http://forums.codeblocks.org/index.php/topic,9054.msg65050.html
REM and pointed to it by http://geotecha.wordpress.com/2013/03/05/building-lapack-libraries-with-mingw-on-windows7/
