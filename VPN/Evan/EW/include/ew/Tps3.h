#ifndef EW_TPS3_H_INCLUDED
#define EW_TPS3_H_INCLUDED
...
/// @class ew::Tps3
/// @headerfile ew/Tps3.h "ew/Tps3.h"
/// @brief Thin-Plate Spline in 3D
///
/// ew::Tps3 is a class of static methods.
/// It implements the thin-plate spline in @f$\mathbb{R}^3@f$.
...
/// Consequently, the array arguments of ew::Tps3 methods should be 16 byte
/// aligned.
///
